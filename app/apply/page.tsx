...
export default function ApplyPage() {
  ...
  const focusFirstError = (form: HTMLFormElement, newErrors: FormErrors) => {
    const order: (keyof FormErrors)[] = ["name", "phone", "email", "privacy_agree"];
          ...
          <section className="mx-auto max-w-5xl px-6 py-12 lg:px-8">
            <div className="overflow-hidden rounded-[28px] border border-slate-200 bg-white shadow-sm">
              ...
              >
                ...
                <input type="hidden" name="_next" value="https://kjtranslate.com/success" />
                      ...
                      <div className="space-y-3">
                        <div className="flex gap-2">
                          ...
                          <button
                            ...
                            className="inline-flex shrink-0 cursor-pointer items-center justify-center rounded-xl bg-[#3f4b74] px-4 py-2.5 text-sm font-semibold text-white transition hover:opacity-90"
                          >
                            주소 검색
                          </button>
                        </div>
  ...
  <div className="mb-4">
    ...
    <p className="mt-1 text-sm text-slate-500">
      ...
      번역공증·아포스티유·대사관 인증 등 <br /> 추가 요청이 있으시면 함께 작성해주세요.
    </p>
  </div>
  ...
  <textarea
    ...
    placeholder={`제출 목적, 긴급 여부, 기타 요청사항들을 입력해주세요.`}
  />
</section>
                  </div>
                </div>
                  ...
                  <section>
                    ...
                    <div className="rounded-2xl border border-slate-200 bg-[#f8f9fd] p-4">
                      <div className="h-36 overflow-y-auto rounded-xl border border-slate-200 bg-white p-5 text-sm leading-7 text-slate-700">
                        ...
                        <p className="mt-5 font-semibold text-[#2f3a63]">1. 수집 항목</p>
                        <p className="mt-1">
                          성명(회사명), 연락처, 이메일, 주소 등 문의 작성 시 입력한 정보
                        </p>

                        <p className="mt-5 font-semibold text-[#2f3a63]">2. 이용 목적</p>
                        <p className="mt-1">견적 안내 및 상담 진행, 문의 응대</p>

                        <p className="mt-5 font-semibold text-[#2f3a63]">
                          3. 보유 및 이용 기간
                        </p>
                        <p className="mt-1">문의 처리 완료 후 1년간 보관 후 파기</p>
                        ...
                        <p className="mt-1">
                          ...
                          다만, 동의하지 않을 경우 견적 안내 및 상담 서비스 이용이 제한될 수 있습니다.
                        </p>
                      </div>
