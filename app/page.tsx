          ...
          <div className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
            <div className="max-w-3xl">
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                ...
                <a
                  href="#services"
                  className="rounded-full border border-[#3f4b74] px-6 py-3 text-sm font-semibold text-[#3f4b74] transition hover:bg-white"
                >
                  서비스 보기
                </a>
              </div>
          ...
          <div className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
            <div className="rounded-[28px] bg-[#3f4b74] px-8 py-10 text-white shadow-lg">
              ...
              <div className="mt-6 flex flex-wrap gap-4 text-sm">
                ...
                <div className="rounded-full bg-white/10 px-4 py-2">카카오톡 상담 가능</div>
              </div>
            </div>
          </div>
        </section>
